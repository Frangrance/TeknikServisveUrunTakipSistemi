...
namespace TeknikServis
{
    ...
    public partial class DBTEKNIKSERVISEntities : DbContext
    {
        ...
        public virtual int MAXKATEGORIURUN()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("MAXKATEGORIURUN");
        }
        ...
        public virtual ObjectResult<URUNKATEGORILER_Result> URUNKATEGORILER()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<URUNKATEGORILER_Result>("URUNKATEGORILER");
        }
